...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='processed_ali20_c.csv',
                 target='avgmem', scale=True, timeenc=0, freq='t', pre_data=None):
...
class Dataset_Pred(Dataset):
    def __init__(self, root_path, pre_data=None, flag='pred', size=None,
                 features='S', data_path='sum.csv',
                 target='avgmem', scale=True, inverse=False, timeenc=0, freq='5min', cols=None):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 4 * 4
